class Player {
  ...
  //    wings Idle   -   wings Down -   wings Up -   wings Charge
  //  крылья бездействуют - крылья опущены - крылья подняты - крылья заряжаются
  ...
  handleEnergy() {
    ...
    //  console.log(this.energy, this.game.eventUpdate);
  }
  flap() {
    this.stopCharge();
